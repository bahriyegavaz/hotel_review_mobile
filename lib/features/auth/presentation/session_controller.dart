...
/// Uygulama yeni açıldı, saklı token okunuyor. Splash ekranı gösterilir.
...
/// Oturumun tek doğruluk kaynağı (single source of truth).
///
/// AuthController login işlemini yapar, başarılı olursa buraya haber verir.
/// Router da burayı dinler. Bu ayrım sayesinde login ekranı "yönlendirme"
/// işiyle hiç uğraşmaz - sadece login olur, gerisini router halleder.
class SessionController extends Notifier<SessionState> {
  @override
  SessionState build() {
    // build() senkron olmak zorunda, bu yüzden restore işlemini
    // başlatıp önce Unknown durumunu döndürüyoruz.
    _restore();
